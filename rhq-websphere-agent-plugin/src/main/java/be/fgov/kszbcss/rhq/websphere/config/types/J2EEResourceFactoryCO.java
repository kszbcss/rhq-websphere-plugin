...
@ConfigObjectType(name = "J2EEResourceFactory")
public interface J2EEResourceFactoryCO extends ConfigObject {
    String getName();
    String getJndiName();
    J2EEResourceProviderCO getProvider();
    J2EEResourcePropertySetCO getPropertySet();
}
