...
@ConfigObjectType(name = "SIBMessagingEngine")
public interface SIBMessagingEngineCO extends ConfigObject {
    String getName();
    String getBusName();
    List<SIBLocalizationPointCO> getLocalizationPoints();
    List<SIBGatewayLinkCO> getGatewayLink();
}
