...
@ConfigObjectType(name = "J2EEResourcePropertySet")
public interface J2EEResourcePropertySetCO extends ConfigObject {
    List<J2EEResourcePropertyCO> getResourceProperties();
}
